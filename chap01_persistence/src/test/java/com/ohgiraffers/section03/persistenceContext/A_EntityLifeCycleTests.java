...
public class A_EntityLifeCycleTests {
        ...
        /*
        * 영속성 콘텍스트는 엔티티 매니저가 엔티티 객체를 저장하는 공간으로 엔티티 객체를 보관하고 관리한다.
    ...
    public void 준영속성_clear_테스트() {
        ...
        foundMenu1.setMenuPrice(44444000);
        foundMenu2.setMenuPrice(44444000);

        //then
        Assertions.assertNotEquals(44444000, entityManager.find(Menu.class, 11).getMenuPrice());
        Assertions.assertNotEquals(44444000, entityManager.find(Menu.class, 12).getMenuPrice());
    }
